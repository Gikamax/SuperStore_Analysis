...
class DataSource:
    """
    Class to handle Data throughout the project.
    ...
    def prepare_data_for_category_barchart(self) -> pd.DataFrame:
        """Data Transformations for Category BarChart. """
    ...
    def prepare_data_for_segment_barchart(self) -> pd.DataFrame:
        """Data Transformation for the Segment Barchart"""
    ...
    def prepare_data_for_linechart(self) -> pd.DataFrame:
        """Data Transformation for Linechart."""
